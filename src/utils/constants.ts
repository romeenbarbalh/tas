...
export const team = [
  ...
  },
  {
    ...
    services: ["placage-brushing", "french-curls-large", "island-twist-large", "fulani-braids-classic", "soft-locs-classic", "cornrows", "barrel-twist", "retwist-simple", "knotless-braids-jumbo", "depart-locks-peigne", "depart-locks-crochet"],
